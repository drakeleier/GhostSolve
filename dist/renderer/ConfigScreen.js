...
const ConfigScreen = ({ onSave, initialConfig }) => {
    ...
    return (react_1.default.createElement("div", { className: "config-screen" },
        react_1.default.createElement("div", { className: "config-container" },
            react_1.default.createElement("h2", null, "GhostSolve by Drake Leier"),
            react_1.default.createElement("h3", { style: { marginTop: '-10px', color: '#777' } }, "Configuration:"),
            react_1.default.createElement("form", { onSubmit: handleSubmit },
                ...
                react_1.default.createElement("div", { className: "form-group" },
                    react_1.default.createElement("label", { htmlFor: "language" }, "Preferred Coding Language:"),
